# Fullstack / NestJS + Next.js — Mid take-home
...
The **NestJS API owns the rules**. The UI must show API errors in human language.
...
- Next.js for the UI.
- **NestJS** for the API. Rules live in Nest services, not in Route Handlers or the React form.
...
- Nest tests for the coverage rule plus a short note on CORS/proxy
