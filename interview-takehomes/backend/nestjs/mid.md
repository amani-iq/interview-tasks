...
| --- | --- |
| Track | Backend |
| Stack | NestJS, TypeScript, PostgreSQL (or SQLite if they explain why) |
...
- Use NestJS.
- You may use TypeORM, Prisma, or Drizzle.
...
- Do not paste a generated CRUD starter and stop.
...
- Keep modules split by domain, not by “controllers / services / everything”.
...
- OpenAPI / Swagger that matches the real errors
